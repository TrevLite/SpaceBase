...
function m.create()
    ...
    function Ob:onTick(dt)
        ...
        local sPortrait,sPortraitPath,nPortraitOffX,nPortraitOffY,nPortraitScl,sTintSprite,tTintColor,bUsePortraitOffsetHack
        if bInvItem then
            sPortrait,sPortraitPath,sTintSprite,tTintColor,nPortraitScl,bUsePortraitOffsetHack = Inventory.getPortrait(rObject)
        else
            ...
            bUsePortraitOffsetHack = rObject.bUsePortraitOffsetHack
        end
        if bUsePortraitOffsetHack then
		...
		if sPortrait then
            ...
            if sPortraitPath == 'Environments/Objects' or bUsePortraitOffsetHack then
